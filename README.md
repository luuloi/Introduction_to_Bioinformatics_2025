...
Hướng dẫn cách làm bài tập:
  ...
  + Cách trình bày câu trả lời: Trình bày giống như ví dụ đã làm sẵn ở mỗi câu (câu trả lời có thể bao gồm text hoặc hình ảnh capture hoặc bao gồm cả text và hình ảnh capture). **Lưu ý:** Xóa đi ví dụ trước khi nộp bài.
